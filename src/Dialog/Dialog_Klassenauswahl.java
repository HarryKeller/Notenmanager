...

{
	...
	private void initGUI() 
	{
		...
		this.btnSchlieﬂen.setActionCommand("Schlieﬂen");
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		else if(e.getActionCommand().equals(btnKlassenuebersicht.getActionCommand())) // Abfrage ob Button Klassenuebersicht gedr¸ckt wurde
		{
		...
		else if(e.getActionCommand().equals(mitemBenutzerWechseln.getActionCommand())) // Abfrage ob Menueitem gedr¸ckt wurde
		{
			this.dispose();
			Dialog_Login dlg_login = new Dialog_Login();
			dlg_login.setVisible(true);
		}
		else if(e.getActionCommand().equals( "F‰cher bearbeiten"))
		{
